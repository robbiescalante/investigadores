@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between pb-8 pt-8">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    ...
                    {!! __('de') !!}
                    <span class="font-semibold text-color-dorado">{{ $paginator->total() }}</span>
                    {!! __('resultados') !!}
                </p>
            </div>
